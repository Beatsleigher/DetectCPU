...
#Region "Variables"
    Public cpu_Watch As Boolean = True
    Public ram_Watch As Boolean = True
    Private WithEvents time As Timer = New Timer
    Private WithEvents time2 As Timer = New Timer
#End Region

#Region "Main stuff"

    ''' <summary>
    ''' Loads CPU information from system via WMI.
    ''' </summary>
...
#End Region
    ...
    ''' <summary>
    ''' Opens window with other system info
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    ...
    ''' <summary>
    ''' Reloads system (CPU) info. Same code as when loading form.
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
...
#Region "Live info"
    Private Sub time_Tick(sender As Object, e As EventArgs) Handles time.Tick
        ToolStripProgressBar1.Value = CInt(cpu.NextValue)
    End Sub

    Private Sub time2_Tick(sender As Object, e As EventArgs) Handles time2.Tick
        ToolStripProgressBar2.Value = CInt(ram.NextValue)
    End Sub

    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        If cpu_Watch = True Then
            ToolStripButton1.Image = My.Resources._1380476494_reload
            time.Stop()
            cpu_Watch = False
            ToolStripProgressBar1.Value = 0
        ElseIf cpu_Watch = False Then
            ToolStripButton1.Image = My.Resources._1380477557_no
            time.Start()
            cpu_Watch = True
        End If
    End Sub
    ...
    Private Sub ToolStripButton2_Click(sender As Object, e As EventArgs) Handles ToolStripButton2.Click
        If ram_Watch = True Then
            ToolStripButton2.Image = My.Resources._1380476494_reload
            time2.Stop()
            ram_Watch = False
            ToolStripProgressBar2.Value = 0
        ElseIf ram_Watch = False Then
            ToolStripButton2.Image = My.Resources._1380477557_no
            time2.Start()
            ram_Watch = True
        End If
    End Sub
